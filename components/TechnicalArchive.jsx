      ...
      <Reveal>
        <div className="archive-header">
          <div className="archive-header-left">
            <div className="section-label">{language === 'id' ? 'Arsip' : 'Archive'}</div>
            <TypewriterTitle text={language === 'id' ? 'Proyek Teknis' : 'Technical Projects'} />
            <p className="archive-description">{language === 'id' ? 'Koleksi lengkap dari karya teknis, sistem, dan proyek digital saya.' : 'A complete collection of my technical work, systems, and digital projects.'}</p>
          </div>
        </div>
      </Reveal>
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="archive-row-main">
                ...
                <div className="archive-row-desc">{language === 'id' && project.descId ? project.descId : project.desc}</div>
                <div className="archive-row-tags">
                  <span className="archive-row-category">{language === 'id' && project.categoryId ? project.categoryId : project.category}</span>
