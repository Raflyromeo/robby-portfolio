    ...
    <>
      <nav ref={navRef} className={`nav-bar ${scrolled ? "scrolled" : ""} ${menuOpen ? "nav-bar--expanded" : ""}`}>
        ...
        {menuOpen && (
          <div className="nav-mobile-menu">
            <div className="nav-mobile-menu-inner">
              ...
              <a href="/#what-i-can-do" className="nav-link" onClick={() => setMenuOpen(false)}>{language === 'id' ? 'Keahlian' : 'What I Can Do'}</a>
              <a href="/#about" className="nav-link" onClick={() => setMenuOpen(false)}>{language === 'id' ? 'Tentang' : 'About'}</a>
              <a href="/#education" className="nav-link" onClick={() => setMenuOpen(false)}>{language === 'id' ? 'Pendidikan' : 'Education'}</a>
              <a href="/#experience" className="nav-link" onClick={() => setMenuOpen(false)}>{language === 'id' ? 'Pengalaman' : 'Experience'}</a>
        ...
        <div className="nav-center hidden md:flex">
          ...
          <a href="/#what-i-can-do" className="nav-link">{language === 'id' ? 'Keahlian' : 'What I Can Do'}</a>
          <a href="/#about" className="nav-link">{language === 'id' ? 'Tentang' : 'About'}</a>
          <a href="/#education" className="nav-link">{language === 'id' ? 'Pendidikan' : 'Education'}</a>
          <a href="/#experience" className="nav-link">{language === 'id' ? 'Pengalaman' : 'Experience'}</a>
        </div>
